 ...
 * 7% opacity adds cinematic texture without crushing legibility.
 */
export function GrainOverlay() {
  return (
    <div
      aria-hidden
      className="pointer-events-none fixed inset-0 z-[60] mix-blend-overlay opacity-[0.07] dark:opacity-[0.12]"
      style={{
        backgroundImage:
